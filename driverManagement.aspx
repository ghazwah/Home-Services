<%@ Page Title="" Language="C#"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="driverManagement.aspx.cs" Inherits="HomeService.driverManagement" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
         ...
         <div class="col-md-8 mx-auto">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <center>
                  <h4><asp:Localize ID="Localize1" meta:resourceKey="Localize1Resource1" text="Driver Form" runat="server"></asp:Localize></h4>
                           ...
                           <asp:Label ID="lblName" runat="server" Text="Name" Class="auto-style1" meta:resourcekey="lblNameResource1" Width="50px"></asp:Label>
                                        <div class="form-group">
                                            <asp:TextBox CssClass="form-control" ID="txtDriverName" runat="server"  meta:resourcekey="txtNameResource1"
                            ...
                            <asp:Label ID="lblAge" runat="server" Text="Age" Class="auto-style1" meta:resourcekey="lblAgeResource1" Width="50px"></asp:Label>
                                        <div class="form-group">
                                            <asp:TextBox CssClass="form-control" ID="txtDriverAge" runat="server" meta:resourcekey="txtAgeResource1"
                                 ...
                                 <asp:Label ID="LblServices" runat="server" Text="Service" Class="auto-style1" meta:resourcekey="lblServiceResource1" Width="70px"></asp:Label>
                                        <div class="form-group">
                                            <asp:TextBox class="form-control" ID="txtServices" runat="server"  meta:resourcekey="txtServicesResource1" ReadOnly="True">1</asp:TextBox>
                                        </div>
                     ...
                     <asp:Label ID="lblNote" runat="server" Text="Note" Class="auto-style1" meta:resourcekey="lblNoteResource1" Width="150px"></asp:Label>
                                ...
                                <div class="row">
                                     ...
                                     <asp:Button ID="btnAdd"  class="btn btn-md btn-block btn-success" runat="server"  Text="Add" OnClick="btnAdd_Click" meta:resourcekey="btnAddResource1"  />
                                      ...
                                      <div class="col-md-3">
                                        <asp:Button ID="btnDelete" class="btn btn-md btn-block btn-danger" runat="server" Text="Delete"  OnClientClick="return confirm('Are you sure? delete this Driver ?');" OnClick="btnDelete_Click"  meta:resourcekey="btnDeleteResource1" />
            ...
            <div class="card">
               <div class="card-body">
                                ...
                                <asp:GridView ID="gvDriver" class="table table-striped table-bordered" runat="server" AutoGenerateColumns="False" DataKeyNames="driverId" Height="112px" Width="602px"  meta:resourcekey="gvDriverResource1">
                                    <Columns>
                                        <asp:TemplateField HeaderText="ID" InsertVisible="False" SortExpression="driverId" meta:resourcekey="TemplateFieldResource1">
                                            <EditItemTemplate>
                                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("driverId") %>' meta:resourcekey="Label1Resource1"></asp:Label>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lbDriverId" runat="server" Text='<%# Bind("driverId") %>'
                                                    OnClick="GetDriverData" meta:resourcekey="lbDriverIdResource1"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Name" SortExpression="driverName" meta:resourcekey="TemplateFieldResource2">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("driverName") %>' meta:resourcekey="TextBox1Resource1"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="Label2" runat="server" Text='<%# Bind("driverName") %>' meta:resourcekey="Label2Resource1"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Age" SortExpression="driverAge" meta:resourcekey="TemplateFieldResource3">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("driverAge") %>' meta:resourcekey="TextBox2Resource1"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("driverAge") %>' meta:resourcekey="Label3Resource1"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Note" SortExpression="note" meta:resourcekey="TemplateFieldResource5">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("note") %>' meta:resourcekey="TextBox4Resource1"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="Label5" runat="server" Text='<%# Bind("note") %>' meta:resourcekey="Label5Resource1"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
