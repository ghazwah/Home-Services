<%@ Page Title="" Language="C#" EnableEventValidation="false"  MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="maidManagement.aspx.cs" Inherits="HomeService.maidManagement" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <center>
                   <h4><asp:Localize ID="Localize1" meta:resourceKey="Localize1Resource1" text="Maid Form" runat="server"></asp:Localize></h4>
                ...
                <asp:Label ID="lblOutput" runat="server" Text=" " CssClass="myFormOutput" meta:resourcekey="lblOutputResource1"></asp:Label>
                               ...
                               <asp:Label ID="lblName" runat="server" Text="Name" Class="auto-style1" meta:resourcekey="lblNameResource1" Width="50px"></asp:Label>
                                        <div class="form-group">
                                            <asp:TextBox CssClass="form-control" ID="txtMaidName" runat="server" meta:resourcekey="txtNameResource1"
                               ...
                               <asp:Label ID="lblAge" runat="server" Text="Age" Class="auto-style1" meta:resourcekey="lblAgeResource1" Width="50px"></asp:Label>
                                        <div class="form-group">
                                            <asp:TextBox CssClass="form-control" ID="txtMaidAge" runat="server" meta:resourcekey="txtAgeResource1"
                               ...
                               <asp:Label ID="LblServices" runat="server" Text="Service" Class="auto-style1" meta:resourcekey="lblServiceResource1" Width="70px"></asp:Label>
                                        <div class="form-group">
                                            <asp:TextBox class="form-control" ID="txtServices" runat="server" meta:resourcekey="txtServicesResource1" ReadOnly="True">2</asp:TextBox>
                                        </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-3">
                                   ...
                                   <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <asp:Button ID="btnDelete" class="btn btn-md btn-block btn-danger" runat="server"  Text="Delete"  OnClick="btnDelete_Click" OnClientClick="return confirm('Are you sure? delete this maid ?');" meta:resourcekey="btnDeleteResource1" />
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <asp:GridView ID="gvMaid" class="table table-striped table-bordered" runat="server" AutoGenerateColumns="False" DataKeyNames="maidId" Height="112px" Width="602px"  meta:resourcekey="gvMaidResource1">
                                            <Columns>
                                                <asp:TemplateField HeaderText="ID" InsertVisible="False" SortExpression="maidId" meta:resourcekey="TemplateFieldResource1">
                                                    <EditItemTemplate>
                                                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("maidId") %>' meta:resourcekey="Label1Resource1"></asp:Label>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lbMaidId" runat="server" Text='<%# Bind("maidId") %>'
                                                            OnClick="GetMaidData" meta:resourcekey="lbMaidIdResource1"></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Name" SortExpression="maidName" meta:resourcekey="TemplateFieldResource2">
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("maidName") %>' meta:resourcekey="TextBox1Resource1"></asp:TextBox>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("maidName") %>' meta:resourcekey="Label2Resource1"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Age" SortExpression="maidAge" meta:resourcekey="TemplateFieldResource3">
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("maidAge") %>' meta:resourcekey="TextBox2Resource1"></asp:TextBox>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label3" runat="server" Text='<%# Bind("maidAge") %>' meta:resourcekey="Label3Resource1"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
