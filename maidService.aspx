<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="maidService.aspx.cs" Inherits="HomeService.maidService" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <h2 class="text-center">
            <asp:Localize ID="locMaids" meta:resourceKey="Localize1Resource10" Text="Maids Information" runat="server"></asp:Localize>
        </h2>
        <br />
        <asp:Repeater ID="Repeater1" runat="server">
         ...
         <tr><td>  <tr><th colspan="4"><asp:Localize ID="locId" meta:resourceKey="Localize1Resource7" text="Maid ID:" runat="server"></asp:Localize> <%#Eval("maidId") %></th></tr>
   ...
   <tr> <td class="contactPhoto"> 
              ...
              <tr><td class="font"><asp:Localize ID="locName" meta:resourceKey="Localize1Resource1" text="Name:" runat="server"></asp:Localize></td><td><%#Eval("maidName") %>
          ...
          <tr><td class="font"> <asp:Localize ID="locAge" meta:resourceKey="Localize1Resource3" text="Age:" runat="server"></asp:Localize></td><td><%#Eval("maidAge") %></td>
          <td><%#Eval("note") %></td>
          </tr>
          ...
          <tr><td class="font"><asp:Localize ID="locExperienceYears" meta:resourceKey="Localize1Resource6" text="ExperienceYears:" runat="server"></asp:Localize></td><td><%#Eval("experienceYears") %></td></tr>
             <tr><td >     <br />   </td></tr>
              ...
              <tr><td><button type="button" class="btn btn-sm btn-block btn-success"  data-toggle="modal" data-target="#exampleModalLong">
                    ...
                    <td>
                        ...
                        <tr>
                            <td class="auto-style3">
                                ...
                                <asp:TextBox ID="txtServices" runat="server" ReadOnly="True" Text="Maid" BackColor="#F8F9FA"></asp:TextBox>
                                <br />
                                 <asp:Localize ID="Localize12" runat="server" meta:resourceKey="lblMaidResource1" Text="Maid Name:"></asp:Localize>
                                <br />
                                <asp:DropDownList ID="ddlMaid" class="btn btn-light dropdown-toggle dropdown-toggle-split" runat="server" AppendDataBoundItems="True">
